...
@Provider @Component class ValidationExceptionMapper : ExceptionMapper<ValidationException> {
  override fun toResponse(exception: ValidationException?): Response {
    return if (exception is ConstraintViolationException) {
      ...
      Response
          ...
          .entity(ErrorMessageDTO(Response.Status.BAD_REQUEST.statusCode, message))
          .build()
    } else {
